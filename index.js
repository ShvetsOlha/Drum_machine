...
function App() {
    ...
    return (
            <div className="App">
    <div className="bg-info text-center min-vh-100 text-white" id="drum-machine">
        
                    <h2>Drum Machine</h2>
                    <div className="drum-pads">
                    {audioClips.map(clip => (
                        <div className='drum-pad' id={audioClips.id} key={audioClips.id}>{audioClips.id}
...
function Pad({ clip, volume, setRecording }) {
    ...
    return (
        <div onClick={playSound} className={`btn btn-secondary p-4 m-3 ${activeKey && "btn-warning"}`} >
